...
export const projects: Project[] = [
  {
    ...
    tags: ['SolidJS', 'Gau', 'Turso', 'Cloudflare Agents'],
    hiddenTags: ['TypeScript', 'Tauri', 'Drizzle', 'Shadcn', 'UnoCSS', 'Iconify', 'AI SDK'],
  ...
  },
  {
    ...
    url: 'https://yuo.app',
    tags: ['SolidJS', 'Auth.js', 'SQLite WASM', 'Turso'],
  ...
  },
  {
    ...
    tags: ['SolidJS', 'Gau', 'Tauri', 'Cloudflare Agents'],
    hiddenTags: ['TypeScript', 'Drizzle', 'Shadcn', 'UnoCSS', 'Iconify', 'AI SDK', 'Turso'],
    category: 'Current Focus',
  },
  {
    name: 'Stealth App',
    description: '',
    tags: ['Svelte', 'Gau', 'Tauri', 'Turso', 'Lin'],
  ...
  },
  {
    ...
    tags: ['TypeScript', 'SolidJS', 'UnoCSS', 'Bun Bake'],
    hiddenTags: ['Bun'],
    category: 'Packages',
  },
  {
    ...
    tags: ['Elysia', 'Cloudflare Cron', 'Cloudflare KV'],
    hiddenTags: ['TypeScript', 'AI SDK'],
    category: 'Packages',
  },
  {
  ...
  },
  {
    ...
    tags: ['SolidJS', 'SQLite WASM', 'Turso', 'Tauri'],
    hiddenTags: ['TypeScript', 'Drizzle', 'UnoCSS', 'Iconify', 'Auth.js'],
    category: 'Starter Templates',
    resume: false,
  },
  {
