...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tags: ['SolidJS', 'SQLite WASM', 'Turso', 'Tauri', 'TypeScript', 'Drizzle', 'UnoCSS'],
    category: 'Current Focus',
  },
  {
    name: 'marko-stack',
    ...
    tags: ['Marko 6', 'Gau', 'Turso', 'Elysia', 'TypeScript', 'UnoCSS', 'Iconify', 'Drizzle'],
  ...
  },
  {
    ...
    tags: ['Astro', 'SolidJS', 'UnoCSS', 'Shadcn', 'Iconify', 'TypeScript'],
    category: 'Sites',
  },
  {
    name: 'lin',
  ...
  },
  {
    ...
    tags: ['TypeScript', 'Tauri', 'Svelte', 'SolidJS', 'Astro', 'Starlight'],
    category: 'Packages',
  },
  {
    name: 'Bun Test UI',
  ...
  },
  {
    ...
    tags: ['SolidJS', 'Gau', 'Turso', 'AI SDK', 'TypeScript', 'Drizzle', 'Shadcn', 'UnoCSS', 'Iconify'],
    category: 'Apps',
  },
  {
  ...
  },
  {
    ...
    tags: ['SolidJS', 'SQLite WASM', 'Turso', 'Tauri', 'TypeScript', 'Drizzle', 'UnoCSS', 'Iconify', 'Auth.js'],
    category: 'Starter Templates',
    resume: false,
  },
  {
  ...
  },
  {
    ...
    tags: ['Vue', 'Ionic Capacitor', 'ASP.NET', 'Docker', 'TypeScript', 'UnoCSS'],
    category: 'Past',
    team: 3,
  },
  {
    ...
    tags: ['Svelte', 'TailwindCSS', 'Supabase', 'AI SDK', 'TypeScript'],
    category: 'Past',
    team: 3,
  },
  {
    ...
    tags: ['Svelte', 'TypeScript', 'TailwindCSS', 'Iconify'],
